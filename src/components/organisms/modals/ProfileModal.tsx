...
export const ProfileModal: React.FC<ProfileModalProps> = ({ user, onUpdate, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-hidden">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md flex flex-col max-h-[90vh] border border-gray-200 dark:border-gray-700">
        
        <div className="bg-indigo-600 dark:bg-indigo-900 p-4 flex justify-between items-center text-white shrink-0 rounded-t-xl">
          <h3 className="font-bold text-lg flex items-center gap-2">
            <User size={20} />
            Mi Perfil
          </h3>
          <button onClick={onClose} className="hover:text-indigo-200"><X size={24} /></button>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex flex-col items-center">
                    <div className="relative group">
                        <div 
                            className="w-24 h-24 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center text-indigo-600 dark:text-indigo-300 text-3xl font-bold overflow-hidden border-2 border-indigo-200 dark:border-indigo-700 cursor-pointer shadow-inner"
