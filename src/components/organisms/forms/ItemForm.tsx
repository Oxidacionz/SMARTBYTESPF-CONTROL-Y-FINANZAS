...
export const ItemForm: React.FC<ItemFormProps> = ({ onAdd, onEdit, initialData, directory, onAddToDirectory, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md overflow-hidden border border-gray-200 dark:border-gray-700 max-h-[90vh] overflow-y-auto">
        <div className="bg-blue-900 dark:bg-blue-950 p-4 flex justify-between items-center text-white sticky top-0 z-10">
          <h3 className="font-bold text-lg">{initialData ? 'Editar Movimiento' : 'Agregar Movimiento'}</h3>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="relative" ref={wrapperRef}>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nombre / Entidad</label>
              <div className="flex gap-2">
                 <div className="relative flex-grow">
                    <input
                        ...
                        className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg p-2 pl-9 focus:ring-2 focus:ring-blue-500 outline-none transition-colors text-sm"
