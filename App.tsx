...
import { FinancialItem, SpecialEvent, Currency, ShoppingItem, ExchangeRates, PhysicalAsset } from './types';
...
function App() {
  ...
  // Modal Openers
  const openEditModal = (item: FinancialItem) => { setEditingItem(item); setShowAddModal(true); };
  const openAddModal = () => { setEditingItem(null); setShowAddModal(true); };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
             ...
             <button 
               ...
               className="w-full bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 text-white font-bold py-4 rounded-xl shadow-md transition-transform transform active:scale-95 flex items-center justify-center gap-2"
             >
               <Plus size={24} />
               Agregar Movimiento
             </button>
